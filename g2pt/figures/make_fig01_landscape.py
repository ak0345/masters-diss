...
Reads results/g2pt/_aggregate/master_table.csv (`08_aggregate.sh`'s output).

The y-axis label carries "G2PT" as a short prefix. Two copies of this figure (this one and
molgpt/figures/make_fig01_landscape.py's) are stacked in the dissertation's Figure 4.1, and
...
def main():
    require(MASTER_TABLE, "bash scripts_g2pt/08_aggregate.sh")
