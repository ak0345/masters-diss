...
conversion step and has no equivalent here -- G2PT emits SMILES directly).
...
Reads results/g2pt/dumps/sweep-*/{base,guided}_smiles.txt (07_final_dump.sh's
...
DUMPS_DIR = rel("results", "g2pt", "dumps")
...
def main():
    require(DUMPS_DIR, "bash scripts_g2pt/07_final_dump.sh")
