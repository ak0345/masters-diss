...
gflow_molgpt.py's `fit()`), but the comparison it draws is exactly the one
...
throughout. Reads logs/molgpt-gfn/sweep-*/train.jsonl.
"""
import glob
import json
import re
...
def main():
    ...
    require(run_dirs[0] if run_dirs else LOGS_DIR, "bash scripts_molgpt/01_train_guides.sh")
