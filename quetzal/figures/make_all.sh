...
# Guide runs kept out of the pooled main figures. Empty by default.
MAIN_EXCLUDE="${MAIN_EXCLUDE:-}"
...
for fam in ${FAMILIES:-osim peri fexo nitrogen}; do
...
run fig16 make_fig16_joint_chemspace.py --families "${FAMILIES_JOINT:-osim,peri,fexo,nitrogen}"
...
run fig17 make_fig17_decoder_artifact.py \
 --families "${FAMILIES_JOINT:-osim,peri,fexo,nitrogen}" \
